...
$site_top = "http://mizukicreative.website/";
...
$from = "info@mizukicreative.website";
...
$Referer_check_domain = "http://mizukicreative.website/";
...
$require = array('subject','お名前','メールアドレス','message');
...
$refrom_name = "MizukiCreative.website";
...
お問い合わせありがとうございます。
確認出来次第、早急にご返信致しますので今しばらくお待ちください。
